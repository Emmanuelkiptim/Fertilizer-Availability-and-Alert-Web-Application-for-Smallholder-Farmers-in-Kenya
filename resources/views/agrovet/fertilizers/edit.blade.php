                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('fertilizers.update', $fertilizer->fertilizer_id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="qty" id="qty" value="{{ old('qty', $fertilizer->qty) }}" min="0" required class="w-full p-2 border rounded dark:bg-gray-700 dark:text-gray-100">
                        ...
                        <div>
                            ...
                            <select name="availability" id="availability" required class="w-full p-2 border rounded dark:bg-gray-700 dark:text-gray-100">
                                <option value="1" {{ old('availability', (int)$fertilizer->availability) === 1 ? 'selected' : '' }}>Available</option>
                                <option value="0" {{ old('availability', (int)$fertilizer->availability) === 0 ? 'selected' : '' }}>Unavailable</option>
                            </select>
